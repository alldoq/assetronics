defmodule Assetronics.Integrations.Adapters.BambooHR.Resolvers do
  @moduledoc """
  Resolves hierarchical references for BambooHR data.

  Handles finding or creating organizations, departments, and locations
  based on text field values from BambooHR.
  """
