    ...
    <div class="max-w-7xl mx-auto">
      ...
      <div class="mb-6">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-primary-dark">Add new software license</h1>
            <p class="text-slate-500 mt-1">Fill in the details to add a new license to track</p>
          </div>
        ...
        <div class="lg:col-span-3">
          <form @submit.prevent="handleSubmit">
            ...
            <div class="mt-6 flex justify-end gap-3">
              ...
              >
                <span v-if="!isSubmitting">Add license</span>
...
import { softwareService, type CreateSoftwareLicenseData } from '@/services/software'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const licenseData: CreateSoftwareLicenseData = {
      name: form.name,
      vendor: form.vendor,
    ...
    const createdLicense = await softwareService.create(licenseData)

    successMessage.value = `License "${createdLicense.name}" has been added successfully.`
